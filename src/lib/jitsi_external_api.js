...
!function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? exports.JitsiMeetExternalAPI = e()
    : t.JitsiMeetExternalAPI = e();
}(self, () =>
  (() => {
    var t = {
        9119: (t, e) => {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            e.BLANK_URL =
              ...
              e.urlSchemeRegex =
              e.ctrlCharactersRegex =
              e.htmlCtrlEntityRegex =
              e.htmlEntitiesRegex =
              e.invalidProtocolRegex =
                void 0,
        ...
        7054: (t, e, r) => {
          ...
          function i(t, e) {
            this.logStorage = t,
              this.stringifyObjects = !(!e || !e.stringifyObjects) &&
                e.stringifyObjects,
              this.storeInterval = e && e.storeInterval ? e.storeInterval : 3e4,
              this.maxEntryLength = e && e.maxEntryLength
                ? e.maxEntryLength
                : 1e4,
              Object.values(n.levels).forEach(function (t) {
                this[t] = function () {
          ...
          i.prototype.stringify = function (t) {
            ...
            i.prototype.formatLogMessage = function (t) {
              for (var e = "", r = 1, n = arguments.length; r < n; r++) {
                var i = arguments[r];
                i instanceof Error
                  ? e += i.toString() + ": " + i.stack
                  : this.stringifyObjects && "object" == typeof i
                  ? e += this.stringify(i)
                  : e += i, r !== n - 1 && (e += " ");
              }
            ...
            i.prototype._log = function () {
              ...
              if (e) {
                ...
                (r && r.text) === e
                  ? r.count += 1
                  : (this.queue.push({ text: e, timestamp: t, count: 1 }),
            ...
            i.prototype._storeLogs = function (t) {
              try {
                ...
                console.error(
                  "LogCollector error when calling logStorage.storeLogs(): ",
                  t,
                );
              }
            },
            i.prototype._flush = function (t, e) {
              ...
              try {
                ...
                console.error(
                  "LogCollector error when calling logStorage.isReady(): ",
                  t,
                );
              }
              this.totalLen > 0 && (r || t) && (r
                ? (this.outputCache.length &&
                  (this.outputCache.forEach(function (t) {
                    this._storeLogs(t);
                  }.bind(this)),
                    this.outputCache = []),
                ...
                this.queue = [],
                this.totalLen = 0),
                e && this._reschedulePublishInterval();
            },
        ...
        9319: (t) => {
          var e = { trace: 0, debug: 1, info: 2, log: 3, warn: 4, error: 5 };
              ...
              for (
                var s = !(t.options.disableCallerInfo || n.disableCallerInfo) &&
                    function () {
                      ...
                      return r[3] &&
                        ...
                        !n || n.length <= 4
                          ? (0 === r[2].indexOf("log@")
                            ? t.methodName = r[3].substr(0, r[3].indexOf("@"))
                            : t.methodName = r[2].substr(0, r[2].indexOf("@")),
                            t)
                          : (t.methodName = n[1],
                            t.fileLocation = n[2],
                            t.line = n[3],
                ...
                if (p && "function" == typeof p) {
                  ...
                  try {
                    ...
                    console.error(
                      "An error occured when trying to log with one of the available transports",
                      t,
                    );
                  }
                }
        ...
        4943: (t, e, r) => {
          var n = r(9319), i = r(7054), o = {}, s = [], a = n.levels.TRACE;
          t.exports = {
            ...
            setLogLevelById: function (t, e) {
              for (var r = e ? o[e] || [] : s, n = 0; n < r.length; n++) {
                r[n].setLevel(t);
              }
            },
        ...
        939: (t, e, r) => {
          ...
          const s = new class extends n {
            ...
            serialize(t = []) {
              if (this.isLocalStorageDisabled()) {
                return this._storage.serialize(t);
              }
              const e = this._storage.length, r = {};
              for (let n = 0; n < e; n++) {
          ...
          const l = "^([a-z][a-z0-9\\.\\+-]*:)";
          function f(t) {
            const e = new RegExp(`${l}+`, "gi"), r = e.exec(t);
            if (r) {
              let n = r[r.length - 1].toLowerCase();
              "http:" !== n && "https:" !== n && (n = "https:"),
                (t = t.substring(e.lastIndex)).startsWith("//") && (t = n + t);
            }
            return t;
          }
          function d() {
          ...
          function h(t) {
            ...
            if (
              t = t.replace(/\s/g, ""),
                ...
                n = r.exec(t),
                n &&
                (e.protocol = n[1].toLowerCase(), t = t.substring(r.lastIndex)),
                r = new RegExp("^(//[^/?#]+)", "gi"),
                n = r.exec(t),
                n
            ) {
              ...
              const o = i.indexOf("@");
              -1 !== o && (i = i.substring(o + 1)), e.host = i;
              const s = i.lastIndexOf(":");
              -1 !== s && (e.port = i.substring(s + 1), i = i.substring(0, s)),
                e.hostname = i;
            }
            if (
              r = new RegExp("^([^?#]*)", "gi"),
                n = r.exec(t),
                n && (i = n[1], t = t.substring(r.lastIndex)),
              ...
              let r = t.indexOf("#", 1);
              -1 === r && (r = t.length),
                e.search = t.substring(0, r),
                t = t.substring(r);
            } else e.search = "";
            return e.hash = t.startsWith("#") ? t : "", e;
          }
          function v(t) {
            const { hash: e, host: r, pathname: n, protocol: i, search: o } =
              t || this;
            let s = "";
            return i && (s += i),
              r && (s += `//${r}`),
          ...
          const g = { window: window.opener || window.parent }, y = "message";
          class m {
            constructor({ postisOptions: t } = {}) {
              this.postis = function (t) {
                var e,
                  ...
                  f = function (t) {
                    ...
                    if (
                      (!o || t.origin === o) && e && e.postis && e.scope === r
                    ) {
                      var n = s[e.method];
                      if (n) {
                        for (var i = 0; i < n.length; i++) {
                          n[i].call(null, e.params);
                        }
                      } else {u[e.method] = u[e.method] || [],
                          u[e.method].push(e.params);}
                    }
                  };
                ...
                var d = {
                    ...
                    destroy: function (t) {
                      clearInterval(e),
                        p = !1,
                        i && "function" == typeof i.removeEventListener &&
                ...
                return e = setInterval(function () {
                  d.send({ method: l, params: h });
                }, 50),
                  d.listen(l, function (t) {
                    if (t === h) {
                      clearInterval(e), p = !0;
                      for (var r = 0; r < a.length; r++) d.send(a[r]);
                      a = [];
                    } else d.send({ method: l, params: t });
                  }),
                  d;
              }({ ...g, ...t }),
                this._receiveCallback = () => {},
                this.postis.listen(y, (t) => this._receiveCallback(t));
            }
            dispose() {
              this.postis.destroy();
            }
            send(t) {
              this.postis.send({ method: y, params: t });
            }
            setReceiveCallback(t) {
              this._receiveCallback = t;
            }
          }
          const b = "request", w = "response";
          class x {
            ...
            emit(t, ...e) {
              ...
              return r && r.size && r.forEach((t) => {
                ...
                n || this._unprocessedMessages.add(e),
                n;
            }
            on(t, e) {
              let r = this._listeners.get(t);
              return r || (r = new Set(), this._listeners.set(t, r)),
                r.add(e),
                this._unprocessedMessages.forEach((t) => {
                  e(...t) && this._unprocessedMessages.delete(t);
                }),
                this;
            }
            removeAllListeners(t) {
              return t ? this._listeners.delete(t) : this._listeners.clear(),
                this;
            }
            removeListener(t, e) {
              const r = this._listeners.get(t);
            ...
            sendEvent(t = {}) {
              this._backend && this._backend.send({ type: "event", data: t });
            }
            sendRequest(t) {
              if (!this._backend) {
              ...
              return new Promise((r, n) => {
                this._responseHandlers.set(e, ({ error: t, result: e }) => {
                  void 0 !== e
                    ? r(e)
                    : n(
                      void 0 !== t
                ...
                try {
                  this._backend.send({ type: b, data: t, id: e });
                } catch (t) {
          ...
          try {
            _ = function (t) {
              ...
              return o.forEach((t) => {
                const r = t.split("="), n = r[0];
                if (!n || n.split(".").some((t) => u.includes(t))) return;
                let o;
                try {
                  if (o = r[1], !e) {
                    const t = decodeURIComponent(o).replace(/\\&/, "&").replace(
                      /[\u2018\u2019]/g,
                      "'",
                    ).replace(/[\u201C\u201D]/g, '"');
                  ...
                  return void function (t) {
                    ...
                    let n = arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : "";
                    console.error(n, t),
                      null === (e = (r = window).onerror) || void 0 === e ||
                      e.call(r, n, void 0, void 0, void 0, t);
          ...
          (window.JitsiMeetJS || (window.JitsiMeetJS = {}),
            ...
            window.JitsiMeetJS.app).setExternalTransportBackend = (t) =>
              undefined.setBackend(t);
          var E = r(4943);
          ...
          const R = ["css/all.css", "libs/alwaysontop.min.js"],
            ...
            L = {
              ...
              "custom-notification-action-triggered":
              ...
              "non-participant-message-received":
            ...
            C = { "_request-desktop-sources": "_requestDesktopSources" };
          let k = 0;
          function j(t, e) {
          ...
          function I(t) {
            ...
            return "string" == typeof t &&
                null !==
                  String(t).match(
                    /([0-9]*\.?[0-9]+)(em|pt|px|((d|l|s)?v)(h|w)|%)$/,
                  )
              ? e = t
              : "number" == typeof t && (e = `${t}px`),
              e;
          }
          class T extends (i()) {
            constructor(t) {
              ...
              const {
                ...
                S = s.getItem("jitsiLocalStorage");
              this._parentNode = o,
                this._url = function (t) {
                  let e;
                  e = t.serverURL && t.room
                    ? new URL(t.room, t.serverURL).toString()
                    : t.room
                    ? t.room
                    : t.url || "";
                  const r = h(f(e));
                  ...
                  if (!r.host) {
                    ...
                    if (e) {
                      const { host: t, hostname: i, pathname: o, port: s } = h(
                        f(`org.jitsi.meet://${e}`),
                      );
                      t && (r.host = t, r.hostname = i, r.port = s),
                        "/" === n && "/" !== o && (n = o);
                    }
                  }
                  const i = t.roomName || t.room;
                  !i ||
                  !r.pathname.endsWith("/") && r.pathname.endsWith(`/${i}`) ||
                  (n.endsWith("/") || (n += "/"), n += i), r.pathname = n;
                  const { jwt: o, lang: s, release: a } = t,
                    c = new URLSearchParams(r.search);
                  o && c.set("jwt", o);
                  const { defaultLanguage: u } = t.configOverwrite || {};
                  (s || u) && c.set("lang", s || u), a && c.set("release", a);
                  const p = c.toString();
                  p && (r.search = `?${p}`);
                  let { hash: l } = r;
                  o && (l = l.length
                    ? `${l}&jwt=${JSON.stringify(o)}`
                    : `#jwt=${JSON.stringify(o)}`);
                  for (
                    const e of [
                      "config",
                      "iceServers",
                    ...
                    const r = d(
                      t[`${e}Overwrite`] || t[e] || t[`${e}Override`],
                    );
                    if (r.length) {
                      let t = `${e}.${r.join(`&${e}.`)}`;
                      l.length ? t = `&${t}` : l = "#", l += t;
                  ...
                  devices: y,
                  userInfo: b,
                  appData: { localStorageContent: S },
                  release: _,
                  url: `https://${t}/#jitsi_meet_external_api_id=${k}`,
                }),
                this._createIFrame(i, n, E),
                this._transport = new x({
                  backend: new m({
                    postisOptions: {
                ...
                Array.isArray(v) && v.length > 0 && this.invite(v),
                this._onload = l,
                this._tmpE2EEKey = w,
            ...
            _createIFrame(t, e, r) {
              ...
              this._frame = document.createElement("iframe"),
                ...
                r && (this._frame.sandbox = r),
                this._frame.src = this._url,
                this._frame = this._parentNode.appendChild(this._frame);
            }
            _getAlwaysOnTopResources() {
              const t = this._frame.contentWindow, e = t.document;
              let r = "";
              const n = e.querySelector("base");
              if (n && n.href) r = n.href;
              else {
                const { protocol: e, host: n } = t.location;
                r = `${e}//${n}`;
              }
              return R.map((t) => new URL(t, r).href);
            }
            _getFormattedDisplayName(t) {
              const { formattedDisplayName: e } = this._participants[t] || {};
              return e;
            }
            ...
            _getLargeVideo() {
              ...
              if (
                this._isLargeVideoVisible && t && t.contentWindow &&
                t.contentWindow.document
              ) return t.contentWindow.document.getElementById("largeVideo");
            }
            _getPrejoinVideo() {
              const t = this.getIFrame();
              if (
                this._isPrejoinVideoVisible && t && t.contentWindow &&
                t.contentWindow.document
              ) return t.contentWindow.document.getElementById("prejoinVideo");
            }
            _getParticipantVideo(t) {
              const e = this.getIFrame();
              if (
                e && e.contentWindow && e.contentWindow.document
              ) {
                return void 0 === t || t === this._myUserID
                  ? e.contentWindow.document.getElementById(
                    "localVideo_container",
                  )
                  : e.contentWindow.document.querySelector(
                    `#participant_${t} video`,
                  );
              }
            }
            _setSize(t, e) {
              const r = I(t), n = I(e);
              void 0 !== r && (this._height = t, this._frame.style.height = r),
                void 0 !== n && (this._width = e, this._frame.style.width = n);
            }
            _setupListeners() {
              this._transport.on("event", (t) => {
                ...
                switch (e) {
                    ...
                    if (void 0 !== this._tmpE2EEKey) {
                      const t = (t) => {
                        ...
                        for (let r = 0; r < t.length; r += 2) {
                          e.push(parseInt(t.substring(r, r + 2), 16));
                        }
                        return e;
                      };
                      this.executeCommand(
                  ...
                  case "participant-joined":
                    this._participants[n] = this._participants[n] || {},
                      this._participants[n].displayName = r.displayName,
                      this._participants[n].formattedDisplayName =
                        r.formattedDisplayName,
                      j(this, 1);
                    break;
                  ...
                  case "display-name-change": {
                    const t = this._participants[n];
                    t &&
                      (t.displayName = r.displayname,
                        t.formattedDisplayName = r.formattedDisplayName);
                    break;
                  }
                  case "email-change": {
                    const t = this._participants[n];
                  ...
                  case "on-prejoin-video-changed":
                    this._isPrejoinVideoVisible = r.isVisible,
            ...
            updateNumberOfParticipants(t) {
              ...
              const e = Object.keys(t).reduce((e, r) => {
                var n;
                return null !== (n = t[r]) && void 0 !== n && n.participants
                  ? Object.keys(t[r].participants).length + e
                  : e;
              }, 0);
            ...
            isP2pActive() {
              return this._transport.sendRequest({ name: "get-p2p-status" });
            }
            ...
            dispose() {
              this.emit("_willDispose"),
                ...
                this.removeAllListeners(),
                this._frame && this._frame.parentNode &&
            ...
            executeCommand(t) {
              if (t in A) {
                ...
                this._transport.sendEvent({ data: r, name: A[t] });
            ...
            invite(t) {
              return Array.isArray(t) && 0 !== t.length
                ? this._transport.sendRequest({ name: "invite", invitees: t })
            ...
            getAvatarURL(t) {
              const { avatarURL: e } = this._participants[t] || {};
              return e;
            }
            getDeploymentInfo() {
            ...
            getDisplayName(t) {
              const { displayName: e } = this._participants[t] || {};
              return e;
            }
            getEmail(t) {
              const { email: e } = this._participants[t] || {};
              return e;
            }
            getIFrame() {
              return this._frame;
            ...
            getSessionId() {
              return this._transport.sendRequest({ name: "session-id" });
            }
            ...
            resizeLargeVideo(t, e) {
              t <= this._width && e <= this._height &&
                this.executeCommand("resizeLargeVideo", t, e);
            }
            ...
            setAudioInputDevice(t, e) {
              return function (t, e, r) {
                return O(t, { id: r, kind: "audioinput", label: e });
              }(this._transport, t, e);
            }
            setAudioOutputDevice(t, e) {
              return function (t, e, r) {
                return O(t, { id: r, kind: "audiooutput", label: e });
              }(this._transport, t, e);
            }
            ...
            setVideoInputDevice(t, e) {
              return function (t, e, r) {
                return O(t, { id: r, kind: "videoinput", label: e });
              }(this._transport, t, e);
            }
            startRecording(t) {
            ...
            async setMediaEncryptionKey(t) {
              ...
              } else {this.executeCommand(
                  "setMediaEncryptionKey",
                  JSON.stringify({ exportedKey: !1, index: r }),
                );}
            }
        ...
        7007: (t) => {
          ...
          var e,
            ...
            n = r && "function" == typeof r.apply
              ? r.apply
              : function (t, e, r) {
                return Function.prototype.apply.call(t, e, r);
              };
          e = r && "function" == typeof r.ownKeys
            ? r.ownKeys
            ...
            t.exports.once = function (t, e) {
              return new Promise(function (r, n) {
                ...
                function o() {
                  ...
                  t.removeListener("error", i), r([].slice.call(arguments));
                }
                v(t, e, o, { once: !0 }),
          ...
          function u(t, e, r, n) {
            ...
            if (
              ...
              "function" == typeof s
                ...
                : n
                ? s.unshift(r)
                : s.push(r), (i = c(t)) > 0 && s.length > i && !s.warned
            ) {
              s.warned = !0;
              var p = new Error(
          ...
          function f(t, e, r) {
            ...
            return void 0 === i
              ...
              ? function (t) {
                for (
                  var e = new Array(t.length), r = 0; r < e.length; ++r
          ...
          function v(t, e, r, n) {
            if ("function" == typeof t.on) n.once ? t.once(e, r) : t.on(e, r);
              ...
              if ("function" != typeof t.addEventListener) {throw new TypeError(
          ...
          Object.defineProperty(o, "defaultMaxListeners", {
            ...
            o.prototype.emit = function (t) {
              for (var e = [], r = 1; r < arguments.length; r++) {e.push(
                  arguments[r],
                );}
            ...
            o.prototype.removeAllListeners = function (t) {
              ...
              if (void 0 === r.removeListener) {
                return 0 === arguments.length
                  ? (this._events = Object.create(null), this._eventsCount = 0)
                  : void 0 !== r[t] && (0 == --this._eventsCount
                    ? this._events = Object.create(null)
                    : delete r[t]),
                  this;
              }
              ...
              else if (void 0 !== e) {for (n = e.length - 1; n >= 0; n--) {this
        ...
        7811: (t) => {
          "use strict";
          t.exports = "undefined" != typeof ArrayBuffer &&
        ...
        3238: (t, e, r) => {
          "use strict";
          var n = r(4576), i = r(7811), o = r(7394), s = n.DataView;
          t.exports = function (t) {
            if (!i || 0 !== o(t)) return !1;
            try {
              return new s(t), !1;
        ...
        5636: (t, e, r) => {
          ...
          t.exports = (p || u) && function (t, e, r) {
            var n, i = c(t), o = void 0 === e ? i : s(e), v = !m || !m(t);
            if (
              a(t), p && (t = l(t, { transfer: [t] }), i === o && (r || v))
            ) return t;
            if (i >= o && (!r || v)) n = y(t, 0, o);
            else {
              var g = r && !v && b ? { maxByteLength: b(t) } : void 0;
              n = new f(o, g);
              for (
                var _ = new d(t), E = new d(n), S = h(o, i), O = 0; O < S; O++
              ) x(E, O, w(_, O));
            }
            return p || u(t), n;
          };
        ...
        4644: (t, e, r) => {
          ...
          if (
            (!M || !u(C) || C === Function.prototype) && (C = function () {
              throw new I("Incorrect invocation");
            },
              M)
          ) { for (n in U) c[n] && b(c[n], C); }
          if ((!M || !k || k === j) && (k = C.prototype, M)) {for (
              n in U
            ) c[n] && b(c[n].prototype, k);}
          ...
          t.exports = {
            ...
            exportTypedArrayStaticMethod: function (t, e, r) {
              ...
              if (a) {
                if (b) {
                  if (r) {for (n in U) {if ((i = c[n]) && l(i, t)) {try {
                          delete i[t];
                        } catch (t) {}}}}
                  if (C[t] && !r) return;
                  try {
        ...
        5370: (t, e, r) => {
          ...
          t.exports = function (t, e, r) {
            for (
              var i = 0, o = arguments.length > 2 ? r : n(e), s = new t(o);
              o > i;
            ) s[i] = e[i++];
            return s;
          };
          ...
          var n = r(6080),
            ...
            a = function (t) {
              ...
              return function (r, a, c) {
                for (
                  var u, p = o(r), l = i(p), f = s(l), d = n(a, c); f-- > 0;
        ...
        4527: (t, e, r) => {
          ...
          t.exports = a
            ? function (t, e) {
              if (i(t) && !s(t, "length").writable) {throw new o(
                  "Cannot set read only .length",
                );}
              return t.length = e;
            }
            : function (t, e) {
        ...
        7628: (t, e, r) => {
          ...
          var n = r(6198);
          t.exports = function (t, e) {
            for (var r = n(t), i = new e(r), o = 0; o < r; o++) {i[o] =
                t[r - o - 1];}
            return i;
          };
        },
        9928: (t, e, r) => {
          "use strict";
          var n = r(6198), i = r(1291), o = RangeError;
          t.exports = function (t, e, r, s) {
            var a = n(t), c = i(r), u = c < 0 ? a + c : c;
        ...
        2106: (t, e, r) => {
          ...
          t.exports = function (t, e, r) {
            return r.get && n(r.get, e, { getter: !0 }),
        ...
        4483: (t, e, r) => {
          ...
          if (u) {d = function (t) {
            ...
            try {
              f || (n = c("worker_threads")) && (f = n.MessageChannel),
                f && (i = new f(),
                  o = new l(2),
                  s = function (t) {
        ...
        4265: (t, e, r) => {
          "use strict";
          var n = r(2839);
          t.exports = /ipad|iphone|ipod/i.test(n) &&
        ...
        9519: (t, e, r) => {
          ...
          var n,
            ...
            p = u && u.v8;
          p && (i = (n = p.split("."))[0] > 0 && n[0] < 4 ? 1 : +(n[0] + n[1])),
            !i && s && (!(n = s.match(/Edge\/(\d+)/)) || n[1] >= 74) &&
            (n = s.match(/Chrome\/(\d+)/)) && (i = +n[1]),
            t.exports = i;
        },
        3607: (t, e, r) => {
          "use strict";
        ...
        6518: (t, e, r) => {
          ...
          var n = r(4576),
            ...
            u = r(2796);
          t.exports = function (t, e) {
            var r, p, l, f, d, h = t.target, v = t.global, g = t.stat;
            if (r = v ? n : g ? n[h] || a(h, {}) : n[h] && n[h].prototype) {
              for (p in e) {
                if (
                  f = e[p],
                    l = t.dontCallGetSet ? (d = i(r, p)) && d.value : r[p],
                    !u(v ? p : h + (g ? "." : "#") + p, t.forced) &&
                    void 0 !== l
                ) {
        ...
        2478: (t, e, r) => {
          ...
          t.exports = function (t, e, r, n, l, f) {
            var d = r + t.length, h = n.length, v = p;
            return void 0 !== l && (l = i(l), v = u),
              a(f, v, function (i, a) {
                var u;
                switch (s(a, 0)) {
                  case "$":
                  ...
                  default:
                    ...
                    if (p > h) {
                      ...
                      return 0 === f
                        ? i
                        : f <= h
                        ? void 0 === n[f - 1] ? s(a, 1) : n[f - 1] + s(a, 1)
                        : i;
                    }
                    u = n[p - 1];
                }
        ...
        4576: function (t, e, r) {
          ...
          t.exports = n("object" == typeof globalThis && globalThis) ||
            ...
            n("object" == typeof this && this) || function () {
            return this;
        ...
        3167: (t, e, r) => {
          ...
          t.exports = function (t, e, r) {
            var s, a;
            return o && n(s = e.constructor) && s !== r && i(a = s.prototype) &&
              a !== r.prototype && o(t, a),
              t;
          };
        },
        ...
        757: (t, e, r) => {
          "use strict";
          var n = r(7751), i = r(4901), o = r(1625), s = r(7040), a = Object;
          t.exports = s
            ? function (t) {
        ...
        713: (t, e, r) => {
          ...
          var n = r(9565),
            ...
            c = r(6319),
            u = a(function () {
              var t = this.iterator, e = o(n(this.next, t));
              if (!(this.done = !!e.done)) {
                return c(t, this.mapper, [e.value, this.counter++], !0);
              }
            });
          t.exports = function (t) {
            return o(this), i(t), new u(s(this), { mapper: t });
          };
        },
        7657: (t, e, r) => {
          "use strict";
          ...
          var n = r(9504),
            ...
            w = t.exports = function (t, e, r) {
              ...
              (e = "[" + g(d(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
                r && r.getter && (e = "get " + e),
                r && r.setter && (e = "set " + e),
                (!s(t, "name") || c && t.name !== e) && (a
                  ? h(t, "name", { value: e, configurable: !0 })
                  : t.name = e),
                m && r && s(r, "arity") && t.length !== r.arity &&
        ...
        1955: (t, e, r) => {
          ...
          if (!x) {
            var _ = new f(),
              E = function () {
                var t, e;
                for (g && (t = b.domain) && t.exit(); e = _.get();) {
                  try {
                    e();
                  } catch (t) {
                    throw _.head && n(), t;
          ...
          var n,
            ...
            y = function () {
              ...
              y = "undefined" != typeof document
                ? document.domain && n ? g(n) : (e = u("iframe"),
                  r = "java" + f + ":",
        ...
        6801: (t, e, r) => {
          ...
          e.f = n && !i ? Object.defineProperties : function (t, e) {
            s(t);
            for (var r, n = a(e), i = c(e), u = i.length, p = 0; u > p;) {
              o.f(t, r = i[p++], n[r]);
            }
            return t;
          };
        ...
        4270: (t, e, r) => {
          ...
          t.exports = function (t, e) {
            var r, a;
            if (
              "string" === e && i(r = t.toString) && !o(a = n(r, t))
            ) return a;
        ...
        7323: (t, e, r) => {
          ...
          (_ || S || E || d || h) && (y = function (t) {
            var e, r, n, i, s, u, p, d = this, h = f(d), O = a(t), R = h.raw;
            if (R) {
            ...
            if (
              L && (C = w(C, "y", ""),
                ...
                S && i && i.length > 1 && o(v, i[0], r, function () {
                  for (
                    s = 1; s < arguments.length - 2; s++
                  ) void 0 === arguments[s] && (i[s] = void 0);
                }),
                i && A
            ) {
              for (i.groups = u = l(null), s = 0; s < A.length; s++) {
                u[(p = A[s])[0]] = i[p[1]];
              }
            }
            return i;
        ...
        2293: (t, e, r) => {
          "use strict";
          var n = r(8551), i = r(5548), o = r(4117), s = r(8227)("species");
          t.exports = function (t, e) {
        ...
        8183: (t, e, r) => {
          ...
          var n = r(9504),
            ...
            p = function (t) {
              return function (e, r) {
                var n, p, l = o(s(e)), f = i(r), d = l.length;
                return f < 0 || f >= d
                  ? t ? "" : void 0
                  : (n = c(l, f)) < 55296 || n > 56319 || f + 1 === d ||
                      (p = c(l, f + 1)) < 56320 || p > 57343
                  ? t ? a(l, f) : n
                  : t
                  ? u(l, f, f + 2)
        ...
        1548: (t, e, r) => {
          ...
          t.exports = !!a && !i(function () {
            if (
              "DENO" === s && o > 92 || "NODE" === s && o > 94 ||
              "BROWSER" === s && o > 97
            ) return !1;
            var t = new ArrayBuffer(8), e = a(t, { transfer: [t] });
        ...
        4495: (t, e, r) => {
          ...
          t.exports = !!Object.getOwnPropertySymbols && !i(function () {
            ...
            return !o(t) || !(Object(t) instanceof Symbol) ||
              !Symbol.sham && n && n < 41;
          });
        },
        9225: (t, e, r) => {
          ...
          b && w || (b = function (t) {
            ...
            var e = p(t) ? t : E(t), r = h(arguments, 1);
            return A[++R] = function () {
              c(e, void 0, r);
            },
              i(R),
            ...
            m
              ...
              ? (s = (o = new S()).port2,
                o.port1.onmessage = j,
                i = u(s.postMessage, s))
              : a.addEventListener && p(a.postMessage) && !a.importScripts &&
                  n && "file:" !== n.protocol && !f(I)
              ? (i = I, a.addEventListener("message", j, !1))
              : i = L in v("script")
                ? function (t) {
        ...
        2777: (t, e, r) => {
          ...
          t.exports = function (t, e) {
            ...
            if (c) {
              if (
                void 0 === e && (e = "default"), r = n(c, t, e), !i(r) || o(r)
              ) return r;
        ...
        655: (t, e, r) => {
          ...
          t.exports = function (t) {
            if ("Symbol" === n(t)) {throw new TypeError(
        ...
        8227: (t, e, r) => {
          ...
          t.exports = function (t) {
            return o(p, t) || (p[t] = a && o(u, t) ? u[t] : l("Symbol." + t)),
              p[t];
          };
        },
        4601: (t, e, r) => {
              ...
              var E = n("Error"),
                S = e(function (t, e) {
                  ...
                  return void 0 !== r && o(n, "message", r),
                    d(n, S, n.stack, 2),
                    this && s(_, this) && p(n, this, S),
                    arguments.length > m && f(n, arguments[m]),
                    n;
                });
              if (
                S.prototype = _,
                  "Error" !== w
                    ? a ? a(S, E) : c(S, E, { name: !0 })
                    : h && y in x && (u(S, x, y), u(S, x, "prepareStackTrace")),
                  c(S, x),
                  !v
              ) {try {
        ...
        6573: (t, e, r) => {
          "use strict";
          var n = r(3724), i = r(2106), o = r(3238), s = ArrayBuffer.prototype;
          n && !("detached" in s) &&
            i(s, "detached", {
              configurable: !0,
              get: function () {
        ...
        7936: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(5636);
          i &&
            n({ target: "ArrayBuffer", proto: !0 }, {
        ...
        8100: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(5636);
          i && n({ target: "ArrayBuffer", proto: !0 }, {
            transfer: function () {
        ...
        4423: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(9617).includes, o = r(9039), s = r(6469);
          n({
            target: "Array",
            proto: !0,
            forced: o(function () {
        ...
        4114: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(8981), o = r(6198), s = r(4527), a = r(6837);
          n({
            target: "Array",
            proto: !0,
            arity: 1,
        ...
        2712: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(926).left, o = r(4598), s = r(9519);
          n({
            target: "Array",
            proto: !0,
        ...
        8111: (t, e, r) => {
          ...
          var n = r(6518),
            ...
            E = function () {
              if (o(this, h), c(this) === h) {throw new w(
          ...
          f(h, b) || S(b, m),
            !_ && f(h, y) && h[y] !== Object || S(y, E),
            E.prototype = h,
            n({ global: !0, constructor: !0, forced: _ }, { Iterator: E });
        },
        7588: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(2652), o = r(9306), s = r(8551), a = r(1767);
        ...
        1701: (t, e, r) => {
          "use strict";
          var n = r(6518), i = r(713);
          n({ target: "Iterator", proto: !0, real: !0, forced: r(6395) }, {
            map: i,
          });
        },
        8237: (t, e, r) => {
        ...
        6499: (t, e, r) => {
          ...
          var n = r(6518),
            ...
            a = r(1103),
            c = r(2652);
          n({ target: "Promise", stat: !0, forced: r(537) }, {
            all: function (t) {
              var e = this,
                r = s.f(e),
                n = r.resolve,
        ...
        2003: (t, e, r) => {
          ...
          var n = r(6518),
            ...
            p = s && s.prototype;
          if (
            n({ target: "Promise", proto: !0, forced: o, real: !0 }, {
              catch: function (t) {
            ...
            p.catch !== l && u(p, "catch", l, { unsafe: !0 });
          }
        },
        436: (t, e, r) => {
          "use strict";
          var n,
            ...
            K = function (t, e) {
              ...
              try {
                a
                  ? (s || (2 === e.rejection && Q(e), e.rejection = 1),
                    !0 === a
                      ? r = o
                      : (l && l.enter(), r = a(o), l && (l.exit(), i = !0)),
                    r === t.promise
                      ? u(new U("Promise-chain cycle"))
                      : (n = J(r))
                      ? p(n, r, c, u)
                      : c(r))
                  : u(o);
            ...
            G = function (t, e, r) {
              ...
              $
                ...
                !j && (i = u["on" + t])
                  ? i(n)
                  : t === W && _("Unhandled promise rejection", r);
            },
            H = function (t) {
              p(w, u, function () {
            ...
            Z = function (t, e, r) {
              t.done ||
                (t.done = !0, r && (t = r), t.value = e, t.state = 2, z(t, !0));
            },
            tt = function (t, e, r) {
              if (!t.done) {
                t.done = !0, r && (t = r);
                try {
                  if (t.facade === e) {throw new U(
          ...
          s({ global: !0, constructor: !0, wrap: !0, forced: k }, {
            Promise: M,
          }),
            d(M, C, !1, !0),
            h(C);
        ...
        1481: (t, e, r) => {
          ...
          n({ target: "Promise", stat: !0, forced: r(916).CONSTRUCTOR }, {
            reject: function (t) {
              var e = i.f(this);
        ...
        4864: (t, e, r) => {
          ...
          if (
            s(
              "RegExp",
              n && (!D || U || E || S || m(function () {
                return M[O] = !1,
                  R(N) !== N || R(M) === M || "/a/i" !== String(R(N, "i"));
              })),
            )
          ) {
            for (
              var B = function (t, e) {
                  ...
                  if (
                    (g || l(A, t)) && (t = t.source, y && (e = h(x))),
                      t = void 0 === t ? "" : d(t),
                      e = void 0 === e ? "" : d(e),
                      x = t,
                      E && "dotAll" in N && (n = !!e && I(e, "s") > -1) &&
                      (e = j(e, /s/g, "")),
                      r = e,
                      U && "sticky" in N && (i = !!e && I(e, "y") > -1) && F &&
                      (e = j(e, /y/g, "")),
                      S && (o = function (t) {
                        for (
                          var e,
        ...
        7495: (t, e, r) => {
          ...
          n({ target: "RegExp", proto: !0, forced: /./.exec !== i }, {
            exec: i,
          });
        },
        5440: (t, e, r) => {
          ...
          s(
            ...
            function (t, e, r) {
              var o = A ? "$" : "$0";
              return [function (t, r) {
                var n = h(this), o = p(t) ? void 0 : g(t, b);
                return o ? i(o, t, n, r) : i(e, d(n), t, r);
              }, function (t, i) {
                var s = c(this), a = d(t);
                if (
                  "string" == typeof i && -1 === S(i, o) && -1 === S(i, "$<")
                ) {
                  var p = r(e, s, a, i);
                ...
                for (var R, A = []; null !== (R = m(s, a)) && (E(A, R), b);) {
                  "" === d(R[0]) && (s.lastIndex = v(a, f(s.lastIndex), g));
                }
                for (var L, C = "", k = 0, j = 0; j < A.length; j++) {
                  for (
                    var I,
                      T = d((R = A[j])[0]),
                      P = w(x(l(R.index), a.length), 0),
                      N = [],
                      M = 1;
                    M < R.length;
                    M++
                  ) E(N, void 0 === (L = R[M]) ? L : String(L));
                  var D = R.groups;
                  if (h) {
                    var U = _([T], N, P, a);
        ...
        8140: (t, e, r) => {
          "use strict";
          var n = r(4644), i = r(6198), o = r(1291), s = n.aTypedArray;
          (0, n.exportTypedArrayMethod)("at", function (t) {
            var e = s(this), r = i(e), n = o(t), a = n >= 0 ? n : r + n;
        ...
        1134: (t, e, r) => {
          "use strict";
          var n = r(4644), i = r(3839).findLastIndex, o = n.aTypedArray;
        ...
        1903: (t, e, r) => {
          "use strict";
          var n = r(4644), i = r(3839).findLast, o = n.aTypedArray;
        ...
        9577: (t, e, r) => {
          ...
          p(
            ...
            {
              with: function (t, e) {
                var r = c(this), i = s(t), p = o(r) ? a(e) : +e;
                return n(r, u(r), i, p);
              },
            }.with,
            !l,
        ...
        4603: (t, e, r) => {
          ...
          d.delete("a", 1),
            ...
            d + "" != "a=2" && n(c, "delete", function (t) {
              ...
              for (
                var i, a = o(t), c = o(r), d = 0, h = 0, v = !1, g = n.length;
                d < g;
              ) i = n[d++], v || i.key === a ? (v = !0, p(this, i.key)) : h++;
              for (; h < g;) {
                (i = n[h++]).key === a && i.value === c ||
                  u(this, i.key, i.value);
              }
    ...
    return r.n = (t) => {
      ...
      r.d = (t, e) => {
        for (var n in e) {r.o(e, n) && !r.o(t, n) &&
