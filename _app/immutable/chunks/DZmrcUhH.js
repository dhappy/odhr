import{a as N,d as k,x as a,r as L,k as v,a9 as p,o as O,R as Y,aa as V,t as z,A as E,W}from"./Qm5UuKnt.js";import{n as l,c as _,o as j,r as b}from"./CeJSdIh9.js";import{T as A,D as F}from"./BVfrt1QW.js";import"./NXOBBj2-.js";import"./sOnjti7P.js";import"./DckfMiz2.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
