import{a as P,d as C,k as D,N as j,x as u,y as K,t as W,R as S,A as _,o as V,M,W as F,r as Q,e as q}from"./BjeNwAQr.js";import{r as s,n as h,c as E,U as m}from"./S2RxXmWo.js";import"./BGHnKu2h.js";import{M as N}from"./CwdkjTUv.js";import"./pfDQoraW.js";import{S as n}from"./dy47Gwce.js";import"./DifwZDM5.js";import"./B9GV3kvT.js";import"./CLI82cdg.js";const H={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",O=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!O&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||O)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!O&&!U&&c.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};let L=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};L.styles=[Y];z([h()],L.prototype,"target",void 0);L=z([E("w3m-swap-input-skeleton")],L);const Z=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var y=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};const J=5e-5;let b=class extends C{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",e=j.bigNumber(t).gt("0");return u`
    ...
    `:u` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){const t=j.multiply(this.balance,this.price),e=t?t==null?void 0:t.gt(J):!1;return u`
