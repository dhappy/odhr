import{p as k,s as C,j as $,a as d,r as y,d as f,x as s,aa as a,e as R}from"./BjeNwAQr.js";import{n as _,c as b,o as O,r as j}from"./S2RxXmWo.js";import{e as P,n as U}from"./Bcio6Zsk.js";import{R as T}from"./Dmg8YACJ.js";const u=k({isLegalCheckboxChecked:!1}),w={state:u,subscribe(r){return $(u,()=>r(u))},subscribeKey(r,e){return C(u,r,e)},setIsLegalCheckboxChecked(r){u.isLegalCheckboxChecked=r}},L=d`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
