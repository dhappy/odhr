import{w as ie,p as se,aO as Z,B as K,aI as q,k as A,D as oe,A as $,aP as ne,s as ae,j as ce,a as R,d as y,x as c,a9 as j,aG as C,aa as U,M as _,m as le,t as ee,W as te,R as L,o as F,y as V,q as ue,l as M,T as de}from"./BjeNwAQr.js";import{n as p,c as g,o as h,r as d}from"./S2RxXmWo.js";import{D as pe,T as me}from"./DLY9BnGM.js";import"./NiR07Ky9.js";import"./CLI82cdg.js";import"./BgCcrv56.js";import"./BacStRzf.js";import{O as Y}from"./9PbnnOBv.js";import"./YtN4Nh_O.js";import"./ht4Xqx92.js";import"./BGHnKu2h.js";import"./BsEm8fjr.js";import"./B9GV3kvT.js";const E={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},G={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},he={providers:Z,selectedProvider:null,error:null,purchaseCurrency:E,paymentCurrency:G,purchaseCurrencies:[E],paymentCurrencies:[],quotesLoading:!1},u=se(he),fe={state:u,subscribe(s){return ce(u,()=>s(u))},subscribeKey(s,e){return ae(u,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=A.state.activeChain===oe.CHAIN.SOLANA?"SOL":"USDC",t=$.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",ne),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}u.selectedProvider=s},setPurchaseCurrency(s){u.purchaseCurrency=s},setPaymentCurrency(s){u.paymentCurrency=s},setPurchaseAmount(s){l.state.purchaseAmount=s},setPaymentAmount(s){l.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();u.purchaseCurrencies=s.purchaseCurrencies,u.paymentCurrencies=s.paymentCurrencies,u.paymentCurrency=s.paymentCurrencies[0]||G,u.purchaseCurrency=s.purchaseCurrencies[0]||E,await q.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await q.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;u.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:u.purchaseCurrency,paymentCurrency:u.paymentCurrency,amount:((s=u.paymentAmount)==null?void 0:s.toString())||"0",network:(e=u.purchaseCurrency)==null?void 0:e.symbol});return u.quotesLoading=!1,u.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return u.error=t.message,u.quotesLoading=!1,null}finally{u.quotesLoading=!1}},resetState(){u.providers=Z,u.selectedProvider=null,u.error=null,u.purchaseCurrency=E,u.paymentCurrency=G,u.purchaseCurrencies=[E],u.paymentCurrencies=[],u.paymentAmount=void 0,u.purchaseAmount=void 0,u.quotesLoading=!1}},l=ie(fe),we=R`
  :host {
    width: 100%;
  }
...
`;var W=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.paymentCurrency,this.currencies=l.state.paymentCurrencies,this.currencyImages=C.state.currencyImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),C.subscribeKey("currencyImages",e=>this.currencyImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(a=U.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!i&&!this.checked;return c`
...
`;var z=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let S=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.purchaseCurrencies,this.tokens=l.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=U.state,i=(a=U.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!i&&!this.checked;return c`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
